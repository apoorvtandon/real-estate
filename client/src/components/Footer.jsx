      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start space-y-8 md:space-y-0">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-slate-700 mb-4">
            Urban Nest is your trusted partner in finding the perfect home. We
            offer
            <br /> a wide range of properties,from cozy apartments to luxurious
            villas, catering
            <br /> to all your real estate needs.Our team of experienced agents
            is dedicated to
            <br /> providing personalized service and expert advice to help you
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link to="/about" className="text-slate-700 hover:text-pink-600">
                About us
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/search" className="text-slate-700 hover:text-pink-600">
                Find a Property
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="text-slate-700">
              <i className="fas fa-phone-alt"></i>+91 9876543210
            </li>
            <li className="text-slate-700">
              <i className="fas fa-envelope"></i>urbannest@gmail.com
            </li>
            <li className="text-slate-700">
